...
angular.module('app').controller('totalMatriculadosController', totalMatriculadosController);

/* @ngInject */
function totalMatriculadosController(turmaDataService, modalService, $filter) {
...
export default 'totalMatriculadosController';
